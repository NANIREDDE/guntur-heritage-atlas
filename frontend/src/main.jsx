...
function App() {
  ...
  const filteredTemples = useMemo(() => !q ? temples : temples.filter(x => `${x.name} ${x.city} ${x.status}`.toLowerCase().includes(q)), [temples, q]);
